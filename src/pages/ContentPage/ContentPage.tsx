...
export const ContentPage: FC<IContentPage> = () => {
    ...
    return (
        <>
            ...
            <div className='content-page_transitions'>
                <IconButton onClick={() => console.log('arrowPrev')
                }>
                    <div>
                        <img src={arrowPrev} alt='arrowPrev' />
                        <div className='content-page_transitions-texts-prev'>
                            <div className='content-page_transitions-title'>
                                Prev
                            </div>
                            <div className='content-page_transitions-text'>
                ...
                <IconButton onClick={() => console.log('arrowNext')
                    ...
                    <div className='content-page_transitions-box'>
                        <div className='content-page_transitions-texts-next'>
                            <div className='content-page_transitions-title'>
                                Next
                            </div>
                            <div className='content-page_transitions-text'>
